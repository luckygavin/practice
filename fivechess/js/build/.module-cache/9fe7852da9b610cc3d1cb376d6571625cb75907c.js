...
var calcPoint = function(){
	resetScore();
	if(step==1){
		var currentWin = blackWins;
		var currentScore = blackScore;
		var oppositeWin = whiteWins;
		var oppositeS = whiteScore;
	}else{
		var currentWin = whiteWins;
		var currentScore = whiteScore;
		var oppositeWin = blackWins;
		var oppositeS = blackScore;
	}
	var max = 0;
	var x, y;
	for(var i=0;i<15;i++){
