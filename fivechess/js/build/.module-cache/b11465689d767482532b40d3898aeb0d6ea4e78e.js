			...
			if(desk[i][j]==0){
				...
				wins[i][j].map(function(value,index){
					...
					switch(num){
						...
						case 3: currentScore += 100; break
						case 4: currentScore += 1000; break
						default: break;
					}
					var numo = opposite[value];
					switch(numo){
						case 1: oppositeScore += 2; break
						case 2: oppositeScore += 12; break
						case 3: oppositeScore += 120; break
						case 4: oppositeScore += 2000; break
						default: break;
					}
				});
