...
var Controller = React.createClass({displayName: "Controller",
	render: function(){
		return (
			React.createElement("div", {className: "controller"}, React.createElement("div", {className: "start"}, React.createElement("span", null, "开 始")))
		);
	}
});
/**
...
var Room = React.createClass({displayName: "Room",
	...
	computerFirst: function(){
		// this.refs.desk.AIStep();	//这里这样是取不到的，执行到这里的时候页面还没渲染，还么有refs
	},
	render: function(){
		return (
			React.createElement("div", null, 
				...
				React.createElement(Controller, {ref: "controller"})
			)
		);
	}
});
